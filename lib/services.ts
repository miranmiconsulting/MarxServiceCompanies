...
export const services: Service[] = [
  ...
  },
  {
    ...
    long:
      "Pollen, dust and bird droppings can knock 15 to 25% off your solar production. We use safe, panel rated cleaning methods to restore output without voiding warranties.",
    icon: "☀️",
  },
];
